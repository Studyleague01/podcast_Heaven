...
const LightAudioPlayer = ({ podcast, audioStream, isPlaying, onTogglePlay, onShare }: LightAudioPlayerProps) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-gradient-to-b from-gray-100 to-white dark:from-zinc-900 dark:to-black backdrop-blur-[25px] z-50 flex flex-col player-backdrop">
        {/* Background decorative elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-32 -right-32 w-96 h-96 bg-orange-500/5 dark:bg-orange-600/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-orange-500/3 dark:bg-orange-600/5 rounded-full blur-3xl"></div>
          <div className="hidden md:block absolute top-1/4 left-10 w-2 h-2 bg-orange-400/50 dark:bg-orange-500/70 rounded-full"></div>
          <div className="hidden md:block absolute top-1/3 right-10 w-3 h-3 bg-orange-400/30 dark:bg-orange-500/50 rounded-full"></div>
          <div className="hidden md:block absolute bottom-1/4 left-1/4 w-2 h-2 bg-orange-400/40 dark:bg-orange-500/60 rounded-full"></div>
        </div>
          ...
          <div className="py-12 px-6 md:p-12 flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start lg:space-x-16 max-w-7xl mx-auto w-full">
            ...
            <figure className="w-full max-w-xs lg:max-w-md mx-auto lg:mx-0 aspect-video rounded-xl overflow-hidden mb-12 lg:mb-0 lg:sticky lg:top-24 group transform-gpu transition-all duration-500">
              <div className="relative w-full h-full">
                ...
                <div className="relative w-full h-full rounded-xl overflow-hidden shadow-2xl border border-gray-200 dark:border-zinc-700/50 group-hover:border-orange-500/30 transition-colors duration-500">
                  <img 
