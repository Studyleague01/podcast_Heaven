...
const LightAudioPlayer = ({ podcast, audioStream, isPlaying, onTogglePlay, onShare }: LightAudioPlayerProps) => {
  ...
  if (!isExpanded) {
    return (
      <>
        ...
        <section 
          className="fixed bottom-6 left-0 right-0 mx-auto w-[90%] max-w-sm bg-zinc-900 backdrop-blur-[25px] z-40 rounded-full shadow-xl border border-zinc-800/40 overflow-hidden transition-all duration-300 transform-gpu will-change-transform"
          role="complementary"
          aria-label="Mini Player"
        >
          {/* Background elements merged for better performance */}
          <div className="absolute inset-0 bg-gradient-to-r from-zinc-900 to-black pointer-events-none opacity-100">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-600/20 to-transparent"></div>
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-orange-500/20 via-white/10 to-orange-500/20"></div>
          </div>
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-gradient-to-b from-zinc-900 to-black backdrop-blur-[25px] z-50 flex flex-col player-backdrop">
        ...
        <div className="px-6 py-4 flex items-center justify-between border-b border-zinc-800 bg-zinc-900 backdrop-blur-[25px] sticky top-0 z-10 shadow-md">
          <button 
            onClick={toggleExpanded}
        ...
        <div className="flex-1 overflow-auto">
          <div className="py-12 px-6 md:p-12 flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start lg:space-x-16 max-w-7xl mx-auto w-full">
            ...
            <div className="flex flex-col w-full max-w-md lg:pt-4 lg:flex-1">
              ...
              <div className="hidden lg:flex items-center space-x-3 mb-6 bg-zinc-800 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <div className="flex justify-center mt-10 space-x-6" role="group" aria-label="Additional controls">
                <button 
                  className="flex items-center space-x-2 text-gray-400 hover:text-orange-400 transition-colors rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500/50 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 backdrop-blur-sm"
              ...
              <section className="mt-12 pt-6 border-t border-zinc-800/50">
                ...
                <div className="bg-zinc-800 rounded-xl p-5 shadow-lg border border-zinc-700 backdrop-blur-sm">
