            ...
            {featuredCreators.map((creator) => (
              <Link key={creator.id} href={creator.url}>
                <a className="flex flex-col items-center group">
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-orange-500 p-0.5 flex-shrink-0 hover:scale-105 transition-transform cursor-pointer relative shadow-lg">
                    <img 
